...
const Carrito = () => {
  ...
  return (
    <div className='container mx-auto mt-[3rem] grid grid-cols-1  md:grid-cols-4 gap-5'>

      <div className='flex items-center gap-4 bg-red-50 p-2 rounded-lg drop-shadow-[0_0px_8px_rgba(0,0,0,0.25)] dark:drop-shadow-[0_0px_8px_white] '>
        <div className='bg-amber-400  p-1 w-[8rem] h-[8rem] rounded-[50%] overflow-hidden'>
          <img className='rounded-[50%]' src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQLwsRggneJ3NGJB1LkmqK0nCFVn7AkBtslvMyifIYzUhvhArdXzvMO7AQWBwcB028Lav4&usqp=CAU" alt="" />
        </div>
      ...
      <div className='flex flex-col gap-2 bg-red-50 drop-shadow-[0_0px_8px_rgba(0,0,0,0.25)] dark:drop-shadow-[0_0px_8px_white] p-2 rounded-lg ' >
        ...
        <div className='flex flex-col gap-2 '>
          ...
          <button className='bg-slate-400 px-4 py-2 text-gray-900 rounded-lg hover:bg-slate-300 hover:text-red-500 transition-colors duration-300 ease-in-out' >Vaciar Carrito</button>
        </div>
      </div>

      <div className='drop-shadow-[0_0px_8px_rgba(0,0,0,0.25)] dark:drop-shadow-[0_0px_8px_white] bg-red-50  rounded-lg col-start-3 col-span-2 row-span-2 p-2 flex flex-col gap-2'>
        <div className='flex items-center gap-2'>
          <div className='rounded-lg bg-black p-2'>
      ...
      <div className='flex gap-2 flex-col drop-shadow-[0_0px_8px_rgba(0,0,0,0.25)] dark:drop-shadow-[0_0px_8px_white] bg-red-50 p-2 rounded-lg col-span-2'>
        <div className='flex items-center gap-2'>
          <div className='rounded-lg bg-black p-2'>
