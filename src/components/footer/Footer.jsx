            ...
            <div className='flex flex-col items-center gap-1'>
                <div className='flex gap-3'>
                    <a href="https://www.linkedin.com/in/cesarignacioaquino/" target="_blank" rel="noopener noreferrer">
                        <svg xmlns="http://www.w3.org/2000/svg" fill="currentColor" className="bi bi-github w-[1.5rem] fill-curious-blue-500" viewBox="0 0 16 16">
                    ...
                    <a href="https://github.com/Cesar-Ignacio" target="_blank" rel="noopener noreferrer">
                        <svg xmlns="http://www.w3.org/2000/svg" fill="currentColor" class="bi bi-linkedin w-[1.4rem] fill-curious-blue-500" viewBox="0 0 16 16">
