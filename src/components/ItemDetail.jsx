  ...
  return (
    <div className='bg-gradient-to-b from-stone-900 bg-amber-50 p-2 gap-4 flex flex-col items-center justify-center  sm:rounded-[1.3rem] sm:flex-row  '>
      ...
      <div className='flex flex-col gap-2 w-[95%] md:w-[50%] z-10'>
        ...
        <p className='text-white  md:text-black'>{producto.descripcion} Lorem ipsum dolor sit amet, consectetur adipisicing elit. Quasi quibusdam quis accusantium distinctio. Est, corrupti.</p>
        ...
        <div className=' flex gap-2 items-center justify-evenly sm:justify-normal'>
          <Link className='group/FiBuy bg-gradient-to-r from-stone-400 bg-slate-200 border-[1px] border-amber-100 hover:bg-slate-50 transition-all duration-300 ease-linear rounded-xl  px-2 py-2 flex items-center gap-1'>
