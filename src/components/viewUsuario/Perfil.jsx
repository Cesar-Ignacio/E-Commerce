...
const Perfil = () => {
    ...
    const { delProducto, productoLiked, cantidadProUsu } = useContext(LikedProductsContext);
                        ...
                        <div className='flex gap-4 items-center justify-evenly '>
                            ...
                            <div className='flex flex-col gap-2  '>
                                <div className='flex items-center'>
                                    ...
                                    <iframe className=' w-[4rem] h-[4rem]'  src="https://lottie.host/embed/8b7b60a5-5813-4c56-b6d9-b3649e69ce60/rR9M1jmhAg.json"></iframe>
